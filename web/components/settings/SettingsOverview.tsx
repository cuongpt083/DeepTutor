...
function languageOptionLabel(
  ...
  if (option === "auto") return t("language.auto");
  if (option === "vi") return t("language.vietnamese");
  if (option === "zh") return t("language.chinese");
  return t("language.english");
}

/** Segmented control for interface (en/zh) or model-output (auto/vi/en/zh). */
function LanguageToggle<T extends string>({
  value,
  onChange,
  options,
}: {
          ...
          <SettingRow
            ...
            control={
              <LanguageToggle
                ...
                options={["auto", "vi", "en", "zh"] as const}
              />
            }
          />
        </SettingSection>
